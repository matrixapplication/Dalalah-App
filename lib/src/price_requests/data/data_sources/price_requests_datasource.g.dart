...
part of 'price_requests_datasource.dart';
...
class _PriceRequestsDatasource implements PriceRequestsDatasource {
  _PriceRequestsDatasource(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<ApiResponse<dynamic>> priceRequest(int id) async {
