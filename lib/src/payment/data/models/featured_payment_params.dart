...
part 'featured_payment_params.g.dart'; 

@JsonSerializable(ignoreUnannotated: false)
class FeaturedPaymentParams {
  @JsonKey(name: 'ad_id')
  int? adId;
  ...
  FeaturedPaymentParams({this.adId, this.adType, this.PaymentId, this.TranId, this.ECI, this.Result, this.TrackId, this.AuthCode, this.ResponseCode, this.RRN, this.responseHash, this.cardBrand, this.amount, this.UserField1, this.UserField3, this.UserField4, this.UserField5, this.cardToken, this.maskedPAN, this.email, this.payFor, this.SubscriptionId, this.PaymentType, this.metaData});

   factory FeaturedPaymentParams.fromJson(Map<String, dynamic> json) => _$FeaturedPaymentParamsFromJson(json);

   Map<String, dynamic> toJson() => _$FeaturedPaymentParamsToJson(this);
}
