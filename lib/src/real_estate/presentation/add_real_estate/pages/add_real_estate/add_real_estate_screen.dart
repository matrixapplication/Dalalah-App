          ...
          child: Column(
            ...
            children: [
              ...
              ChooseFromListItemWidget(
                ...
                width: MediaQuery.of(context).size.width*0.42,
                  onChoose: (ChooseItemListModel item) {
                    ...
                    ChooseItemListModel( id: 1, title: strings.to_sell,),
              ...
              ChooseFromListItemWidget(
                ...
                ChooseItemListModel( id: 1, title: strings.residential,),
                        ...
                        ...categoriesDetails.data!.details!.map((e) {
                          if(e.type=='input'){
                           return Padding(
                             ...
                             child: InputWidget(title: e.name??'',
                              onChanged: (val){
                                  ...
                                  SizedBox(
                                    ...
                                    child: DropDownField(
                                      ...
                                      onChanged: (item) {
                                        if(detailsList.map((w) => w.id==e.id).isNotEmpty){
                                          detailsList.removeWhere((w) => w.id==e.id);
                                          detailsList.add(DetailsItemModelDto(id: e.id,title:item!.title!));
                                        }else{
                                          detailsList.add(DetailsItemModelDto(id: e.id,title:item!.title!));
                                        }
                            ...
                            return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: RadioGridList(
                                      items:e.options!.map((a) =>  RadioItem(value: a.id!, title: a.name??'',)).toList(),
                                      groupValue:'1',
                                      onChanged: (RadioItem radio) {
                                        if(detailsList.map((w) => w.id==e.id).isNotEmpty){
                                          detailsList.removeWhere((w) => w.id==e.id);
                                          detailsList.add(DetailsItemModelDto(id: e.id,title:radio.title));
                                        }else{
                                          detailsList.add(DetailsItemModelDto(id: e.id,title:radio.title));
                                        }
                                    },
