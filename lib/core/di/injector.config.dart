...
import '../../src/auth/presentation/bloc/auth_bloc.dart' as _i83;
import '../../src/auth/presentation/bloc/forgot_password_bloc.dart' as _i92;
...
import '../../src/cars/presentation/cars/bloc/cars_bloc.dart' as _i85;
...
import '../../src/filter/presentation/bloc/filter_bloc.dart' as _i90;
...
import '../../src/home/presentation/bloc/home_bloc.dart' as _i93;
...
import '../../src/installment/domain/use_cases/installment_usecase.dart'
    as _i63;
import '../../src/installment/presentation/bloc/installment_bloc.dart' as _i94;
...
import '../../src/profile/presentation/bloc/edit_profile_bloc.dart' as _i87;
...
import '../../src/showrooms/presentation/showrooms/bloc/showrooms_bloc.dart'
    as _i105;
import 'injection_module.dart' as _i106;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i71.RealEstatePageCubit>(
      () => _i71.RealEstatePageCubit(gh<_i65.NotificationsUseCase>()));
  ...
  gh.factory<_i82.AgencyCubit>(
      () => _i82.AgencyCubit(gh<_i77.ShowroomsUseCase>()));
  gh.factory<_i83.AuthCubit>(() => _i83.AuthCubit(
        gh<_i26.AuthUseCase>(),
        gh<_i21.SellCarUseCase>(),
      ));
  gh.factory<_i84.BranchesCubit>(
      () => _i84.BranchesCubit(gh<_i77.ShowroomsUseCase>()));
  gh.factory<_i85.CarsCubit>(() => _i85.CarsCubit(
        gh<_i62.HomeUseCase>(),
        gh<_i59.FavoritesUseCase>(),
        gh<_i57.CarsUseCase>(),
        gh<_i21.SellCarUseCase>(),
  ...
  gh.factory<_i86.CarsDetailsCubit>(() => _i86.CarsDetailsCubit(
        gh<_i57.CarsUseCase>(),
        gh<_i59.FavoritesUseCase>(),
      ));
  gh.factory<_i87.EditProfileBloc>(() => _i87.EditProfileBloc(
        gh<_i70.ProfileUseCase>(),
        gh<_i21.SellCarUseCase>(),
      ));
  gh.factory<_i88.FavoriteCarsCubit>(
      () => _i88.FavoriteCarsCubit(gh<_i59.FavoritesUseCase>()));
  gh.factory<_i89.FavoritePlatesCubit>(
      () => _i89.FavoritePlatesCubit(gh<_i59.FavoritesUseCase>()));
  gh.factory<_i90.FilterCubit>(
      () => _i90.FilterCubit(gh<_i60.FilterUseCase>()));
  gh.factory<_i91.FollowedShowroomsCubit>(
      () => _i91.FollowedShowroomsCubit(gh<_i77.ShowroomsUseCase>()));
  gh.factory<_i92.ForgotPasswordCubit>(
      () => _i92.ForgotPasswordCubit(gh<_i61.ForgotPasswordUseCase>()));
  gh.factory<_i93.HomeCubit>(() => _i93.HomeCubit(
        gh<_i62.HomeUseCase>(),
        gh<_i59.FavoritesUseCase>(),
        gh<_i68.PlatesUseCase>(),
      ));
  gh.factory<_i94.InstallmentBloc>(
      () => _i94.InstallmentBloc(gh<_i63.InstallmentUseCase>()));
  gh.factory<_i95.MyPlatesCubit>(() => _i95.MyPlatesCubit(
        gh<_i59.FavoritesUseCase>(),
        gh<_i68.PlatesUseCase>(),
      ));
  gh.factory<_i96.NotificationsCubit>(
      () => _i96.NotificationsCubit(gh<_i66.NotificationsUseCase>()));
  gh.factory<_i97.PaymentBloc>(
      () => _i97.PaymentBloc(gh<_i67.PaymentUseCase>()));
  ...
  gh.factory<_i100.PriceRequestsCubit>(
      () => _i100.PriceRequestsCubit(gh<_i69.PriceRequestsUseCase>()));
  gh.factory<_i101.ProfileBloc>(
      () => _i101.ProfileBloc(gh<_i70.ProfileUseCase>()));
  gh.factory<_i102.ShowroomCarsCubit>(() => _i102.ShowroomCarsCubit(
        gh<_i77.ShowroomsUseCase>(),
        gh<_i59.FavoritesUseCase>(),
      ));
  gh.factory<_i103.ShowroomDetailsCubit>(
      () => _i103.ShowroomDetailsCubit(gh<_i77.ShowroomsUseCase>()));
  gh.factory<_i104.ShowroomPlateCubit>(() => _i104.ShowroomPlateCubit(
        gh<_i77.ShowroomsUseCase>(),
        gh<_i59.FavoritesUseCase>(),
      ));
  gh.factory<_i105.ShowroomsCubit>(
      () => _i105.ShowroomsCubit(gh<_i77.ShowroomsUseCase>()));
  return getIt;
}
